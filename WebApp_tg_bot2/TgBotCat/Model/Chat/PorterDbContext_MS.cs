...
{
    public class PorterDbContext_MS : DbContext, IChat
    {
        ...
        private bool Debug;
        public PorterDbContext_MS(DbContextOptions<PorterDbContext_MS> options)
            : base(options)
        {
        }
        public PorterDbContext_MS(bool Debug)
        {
            Database.EnsureCreated();
            this.Debug = Debug;
            chats.Include(t => t.users).Load();
        }
        public PorterDbContext_MS()
        {
            Database.EnsureCreated();
            //this.Debug = Debug;
            //chats.Include(t => t.users).Load();
